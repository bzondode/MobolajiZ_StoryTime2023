...
answer = input("Please select option A through C: ")
print()
...
print("You go with your guts and decide on one of them:")
print("  A. HorseCart")
print("  B. Van")
respnse = input("Please select option A through B: ")
A = "A"
B = "B"

  # Determine if response is the right one
if(respnse == A):
  ...
  print("Wrong selection! This will cost the old blind man the needed medical attention to stay alive")
...
print("He gestures to a math problem that reads as follows:")
w = 2 * (3 + 1)
solve = int(input("Please enter the solution to this problem: "))
